    ...
    Observable.fromEvent = function (element, eventName, selector, eventListenerOptions) {
        ...
        if (element.addListener) {
            return fromEventPattern(
                function (h) {
                    element.addListener(eventName, h, eventListenerOptions);
                },
                function (h) {
                    element.removeListener(eventName, h, eventListenerOptions);
                },
                selector);
        }
        ...
        if (!Rx.config.useNativeEvents) {
            ...
            if (typeof element.on === 'function' && typeof element.off === 'function') {
                return fromEventPattern(
                    function (h) {
                        element.on(eventName, h, eventListenerOptions);
                    },
                    function (h) {
                        element.off(eventName, h, eventListenerOptions);
                    },
                    selector);
            }
        }
